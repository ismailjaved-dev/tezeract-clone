    ...
    <div id='service-page'>
      ...
      <div id='hero-line'>
        ...
        {/* <div id='hero-animation'></div> */}
          ...
          <p id="hero-text" className={darkCheck && "hero-text-dark"}>Introducing our game-changing lead generation solution tailored specifically for businesses like yours. Say goodbye to inconsistent leads and hello to a steady stream of high-converting prospects.
          <br /><br /><br />
